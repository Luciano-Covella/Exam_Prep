...
# Session-State für Upload initialisieren
...
if menu == "📁 Upload CSV":
    ...
    if uploaded:
        st.session_state.portfolio_file = uploaded
        st.success("✅ File uploaded successfully. Use the sidebar to continue.")

# Aktuelle Datei holen
uploaded_file = st.session_state.portfolio_file

# Nur fortfahren, wenn eine Datei vorhanden ist
if uploaded_file is not None:
    # Robust lesen + Fehlerbehandlung
    try:
